  ...
  const projects = [
    {
      title: "Noteswala",
      description:
        "A comprehensive study platform for medical students offering access to handwritten notes and study material with advanced search and filtering capabilities.",
    ...
    },
    {
      ...
      description:
        "An e-commerce platform selling premium study notes with product listings, secure checkout, and user management features.",
